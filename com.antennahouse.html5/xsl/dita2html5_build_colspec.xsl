...
<!--
    **************************************************************
    ...
    Module: Build colspec tree for table processing
    **************************************************************
...
>
    ...
    <xsl:template name="buildColSpecTree" as="document-node()">
        ...
        <xsl:assert test="$colWidthSum gt 0" select="'[ERROR][buildColSpecTree] Invalid colwidth table=', ahf:getHistoryStr($prmTgroup/parent::*),' $colspecComplemented=',$colspecComplemented"/>
